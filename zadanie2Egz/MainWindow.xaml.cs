...
namespace zadanie2Egz
{
    ...
    public partial class MainWindow : Window
    {
            ...
            try
            {
                ...
                if (isCarreting)
                {
                    if (isOnFirstNum)
                    {
                        ...
                        double total = Math.Pow(Double.Parse(firstNum), Double.Parse(sum));
                        TopTextBox.Clear();
                        secondNum = "";
                    ...
                    {
                        double total = Math.Pow(Double.Parse(secondNum), Double.Parse(sum));
                        TopTextBox.Clear();
                        secondNum = "";
                        BottomTextBox.Text = total.ToString();
        ...
        private void Logarytm(object sender, RoutedEventArgs e)
        {
            ...
            {
                if (firstNum.Equals("")) return;
                firstNum = (Math.Log(Double.Parse(firstNum))).ToString();
                BottomTextBox.Text = firstNum;
            }
            else return;
            SqrRootButton.IsTabStop = false;
        ...
        private void Logarytm10(object sender, RoutedEventArgs e)
        {
            RemoveError();
            if (isOnFirstNum)
            {
                if (firstNum.Equals("")) return;
                firstNum = (Math.Log10(Double.Parse(firstNum))).ToString();
                BottomTextBox.Text = firstNum;
            }
            else return;
            SqrRootButton.IsTabStop= false;
        ...
        private void SwitchSigns(object sender, RoutedEventArgs routedEventArgs)
        {
            ...
            else
            {
                ...
                {
                    string currentString = BottomTextBox.Text.Substring(0, BottomTextBox.Text.Length - sum.Length);
                    sum = (-Double.Parse(sum)).ToString();
                    BottomTextBox.Text = currentString + sum;
                }
                else
                {
                    string currentString = BottomTextBox.Text.Substring(0, BottomTextBox.Text.Length - sum.Length);
